...
const MonthlyLineChart = ({ transactions, type, currency }) => {
  ...
  return (
    <div className="h-48 w-full min-h-[250px] md:min-h-[350px] lg:min-h-[390px] bg-white p-6 rounded-xl shadow-sm">
      <h1 className="text-lg font-semibold mb-2 capitalize">{type} Chart</h1>

      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={chartData} margin={{ top: 6, right: 10, left: -15, bottom:20 }}>
